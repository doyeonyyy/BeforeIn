...
class CommunityPageView: UIView {
    ...
    func setUI(){
        ...
        titleLabel.snp.makeConstraints {
            $0.top.equalTo(dataLabel.snp.bottom).offset(35)
        ...
        likeButton.snp.makeConstraints {
            $0.right.equalTo(contentTextView.snp.right).offset(-40)
            $0.bottom.equalTo(contentTextView.snp.bottom).offset(-8)
        }
        
        likeLabel.snp.makeConstraints {
            $0.left.equalTo(likeButton.snp.right).offset(5)
            $0.right.equalTo(contentTextView.snp.right).offset(-5)
            $0.bottom.equalTo(contentTextView.snp.bottom).offset(-11)
        }
        
        categoryButton.snp.makeConstraints {
            $0.left.equalTo(contentTextView.snp.left).offset(5)
            $0.bottom.equalTo(contentTextView.snp.bottom).offset(-8)
        }
        ...
        commentLabel.snp.makeConstraints {
            $0.top.equalTo(BottomView.snp.bottom).offset(16)
